...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Selection.BackgroundColor3 = Color3.fromRGB(172, 230, 167)
            ...
            Gui.Select.ImageColor3 = Color3.fromRGB(172, 230, 167)
            ...
            Gui.Select_2.ImageColor3 = Color3.fromRGB(172, 230, 167)
            ...
            Gui.Select_3.ImageColor3 = Color3.fromRGB(172, 230, 167)
            ...
            Gui.Watermark = Instance.new("TextLabel")
            Gui.Watermark.Name = "Watermark"
            Gui.Watermark.Parent = Gui.Window
            Gui.Watermark.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("euphoria | %s | %s"):format(userId, gameName)
...
function UILibrary.Window:ChangeCategory(new)
    ...
    if Object and self.currentSelection ~= Object then
        ...
        TweenService:Create(
            ...
            TI,
            {
                ImageColor3 = Color3.fromRGB(172, 230, 167)
            }
        ):Play()
        ...
        TweenService:Create(
            ...
            TI,
            {
                TextColor3 = Color3.fromRGB(172, 230, 167)
            }
        ):Play()
